...
# USED TO TRANSLATE TO STRINGS AS FAR AS I KNOW
...
class Quiz(models.Model):
    '''auto_now_add will always show you the time it was first created 
    && auto_now will update it every time Model.save() will be called.'''
...
class Question(Updated):
    ...
    difficulty = models.IntegerField(
        choices=SCALE, default=2, verbose_name=_("Difficulty"))
